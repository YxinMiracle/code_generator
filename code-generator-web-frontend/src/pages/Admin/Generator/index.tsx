...
import '@umijs/max';
import { Button, message, Space, Typography, Tag, Select } from 'antd';
...
const GeneratorAdminPage: React.FC = () => {
  ...
  //   "tags": "[\"Java\"]",
  //   "userId": "1",
  //   "createTime": "2024-06-20T08:44:49.000+00:00",
  //   "updateTime": "2024-06-20T08:48:42.000+00:00",
  //   "isDelete": 0
  // }
    ...
    },
    {
      ...
      render(_, record) {
        if (!record.tags) {
          ...
          return JSON.parse(record.tags as string).map((item: string) => {
